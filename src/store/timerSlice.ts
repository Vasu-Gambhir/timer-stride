...
const timerSlice = createSlice({
  ...
  initialState,
  reducers: {
    createTimer: (state, action: PayloadAction<Omit<Timer, 'id' | 'status' | 'startTime' | 'elapsedTime'>>) => {
    ...
    updateTimerElapsed: (state, action: PayloadAction<{ timerId: string; elapsed: number }>) => {
